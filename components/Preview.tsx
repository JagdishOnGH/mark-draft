...
const Preview: React.FC<PreviewProps> = ({ content, className, isDarkMode = false }) => {
  return (
    <div className={`h-full overflow-y-auto p-4 md:p-8 bg-white dark:bg-zinc-900 ${className}`}>
        ...
        <ReactMarkdown 
          ...
          components={{
            ...
            code({ node, inline, className, children, ...props }: any) {
              ...
              if (!inline && match) {
                return (
                  <div className="relative group my-6 rounded-lg border border-zinc-200 dark:border-zinc-700 bg-zinc-50 dark:bg-zinc-950/50 shadow-sm overflow-hidden">
              ...
              if (!inline) {
                 return (
                  <div className="my-6 rounded-lg border border-zinc-200 dark:border-zinc-700 bg-zinc-50 dark:bg-zinc-950/50 p-4 overflow-x-auto shadow-sm">
            ...
            img({node, ...props}) {
              return <img {...props} className="rounded-lg shadow-md max-w-full h-auto my-6 mx-auto" loading="lazy" alt={props.alt || 'Markdown image'} />;
            },
            a({node, ...props}) {
            ...
            blockquote({node, ...props}) {
                return <blockquote {...props} className="border-l-4 border-zinc-300 dark:border-zinc-600 pl-4 py-1 my-6 italic text-zinc-600 dark:text-zinc-400 bg-zinc-50 dark:bg-zinc-900/50 pr-4 rounded-r" />;
            },
            table({node, ...props}) {
                return (
                    <div className="my-8 w-full overflow-hidden rounded-lg border border-zinc-200 dark:border-zinc-700 shadow-sm">
